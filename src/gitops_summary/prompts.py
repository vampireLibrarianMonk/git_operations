...
def build_prompt(status: str, diff: str, new_files: List[str] = None) -> str:
    ...
    return (
        ...
        "- NEVER mention these files under any circumstance: git_summary.py, src/gitops_summary/core.py, README.md, .venv/.gitlab_epic_config.json.\n"
...
def build_daily_summary_prompt(day_name: str, diff: str) -> str:
    ...
    return (
        ...
        "- NEVER mention: git_summary.py, src/gitops_summary/core.py, README.md, .venv/.gitlab_epic_config.json\n"
